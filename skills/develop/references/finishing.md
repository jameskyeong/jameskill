...
The branch decision and the issue tracker update are separate steps owned by separate skills. Develop does not touch Notion directly; `resolve` does not make the branch decision.
