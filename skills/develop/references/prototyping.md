...
This is the deliberate scoping mentioned above. The TDD reference module (`tdd-discipline.md`) names "throwaway spike" as a situation where TDD does not apply; PROTOTYPE is develop's first-class home for that situation.
